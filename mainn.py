...
st.set_page_config(
    page_title="Aplikasi Cek BBM", 
    page_icon="🚙",
)

st.info("""
# Aplikasi Cek BBM
Ini adalah aplikasi untuk mengecek besaran maksimal liter bahan bakar perjalanan dinas luar kota yang mengacu pada Standar Biaya Kebutuhan Bahan Bakar Kendaraan Perjalanan Dinas yang dapat diakses pada link berikut https://drive.google.com/file/d/1bdTsk07F3s_nfRUEd6_uDbTR0fru7Tks/view?usp=sharing
""")
...
if asal == "Kota Bandung" and tujuan == "Kab. Bandung":
  st.info ("Jumlah Maksimalnya adalah 18 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 22 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 32 liter")

elif asal == "Kab. Bandung Barat" and tujuan == "Kab. Karawang":
     st.info ("Jumlah Maksimalnya adalah 21 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 60 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 16 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 53 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 67 liter")
     ...
     st.info ("Jumlah Maksimalnya adalah 39 liter")
